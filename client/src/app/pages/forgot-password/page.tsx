    ...
    <div className="max-w-[1100px] w-full mx-auto flex flex-col items-center min-h-[calc(100vh-4.5rem)] px-4 sm:px-8 xl:px-0 pt-[8.5rem] pb-[4rem]">
      {isSuccess ? (
        ...
        <div className="max-w-[450px] w-[100%] rounded-[var(--r1)] p-4 sm:p-8 bg-white custom-border-1">
          <p className="font-bold text-xl mb-8">Send Email</p>
          <form onSubmit={handleForgotPassword}>
            ...
            <button
              type="submit"
              className="h-[41.6px] flex items-center justify-center rounded-[var(--r1)] mt-4 px-4 w-full text-white bg-blue-600 text-[var(--white-1)] hover:bg-blue-500"
            >
