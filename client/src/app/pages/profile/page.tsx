...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="relative flex flex-col items-center mx-auto min-h-[calc(100vh-4.5rem)] px-4 sm:px-8 pt-[6rem] md:pt-[8rem] pb-[4rem]">
      ...
      <div className="max-w-[1280px] flex flex-col md:flex-row w-full mt-4 sm:mt-8">
        ...
        {isSuccess && (
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 md:flex md:flex-wrap md:flex-col bg-white rounded-[var(--r1)] p-4 lg:p-4 w-full md:w-[225px] md:sticky top-[6.5rem] h-fit custom-border-1">
