...
const Hero: React.FC = () => {
  return (
    <div className="max-w-[1100px] w-[100%] flex flex-col items-center border border-dashed border-white rounded-[50px] p-16">
      ...
      <form className="relative w-full xl:max-w-[1100px] hidden sm:flex rounded-full">
        ...
        <button className="absolute bg-blue-600 top-[8.25px] right-[8.25px] py-[0.5rem] w-[88.91px] text-center border-none outline-none hover:bg-blue-500 rounded-[50px] text-white">
          Search
        </button>
