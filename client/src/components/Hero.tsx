    ...
    <div className="max-w-[1100px] w-[100%] flex flex-col items-center">
      ...
      <form className="relative w-full xl:max-w-[1100px] hidden sm:flex rounded-full">
        <input
          ...
          className="w-full p-2 sm:p-4 pl-4 sm:pl-12 rounded-[25px] focus:outline-none placeholder:text-sm sm:placeholder:text-sm placeholder:text-slate-500 focus:placeholder:text-transparent"
        />
