...
const UserQuickLinks: React.FC = () => {
  ...
  return (
    <>
      ...
      {isSuccess && (
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 md:flex md:flex-wrap md:flex-col rounded-[var(--r1)] p-4 w-full md:w-[250px] md:sticky top-[6.5rem] h-fit custom-shadow-1 bg-white">
