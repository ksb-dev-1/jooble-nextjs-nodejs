...
const QuickLinksSkeleton = () => {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 md:flex md:flex-wrap md:flex-col bg-white rounded-[var(--r1)] p-4 lg:p-8 w-full md:w-[225px] md:sticky top-[6.5rem] h-fit custom-border-1">
      <Skeleton
        height={40}
        borderRadius={0}
